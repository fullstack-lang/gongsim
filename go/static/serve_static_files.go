...
import (
	...
	"github.com/fullstack-lang/gongsim"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(gongsim.NgDistNg, "ng-github.com-fullstack-lang-gongsim/dist/ng-github.com-fullstack-lang-gongsim/browser")))
