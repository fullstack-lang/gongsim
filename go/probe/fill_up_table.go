...
func fillUpTablePointerToGongstruct[T models.PointerToGongstruct](
	...
	case *models.DummyAgent:
		fillUpTable[models.DummyAgent](playground)
	case *models.Engine:
		fillUpTable[models.Engine](playground)
	case *models.Event:
		fillUpTable[models.Event](playground)
	case *models.GongsimCommand:
		fillUpTable[models.GongsimCommand](playground)
	case *models.GongsimStatus:
		fillUpTable[models.GongsimStatus](playground)
	default:
