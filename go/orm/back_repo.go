...
func NewBackRepo(stage *models.StageStruct, filename string) (backRepo *BackRepoStruct) {
	...
	backRepo.BackRepoGongsimCommand = BackRepoGongsimCommandStruct{
		Map_GongsimCommandDBID_GongsimCommandPtr: make(map[uint]*models.GongsimCommand, 0),
...
func (backRepoStruct *BackRepoStruct) broadcastNbCommitToBack() {
	...
	for _, ch := range backRepoStruct.subscribers {
		...
		default:
			...
			log.Println("github.com/fullstack-lang/gongsim/go: Channel no longer active", backRepoStruct.stage.GetPath())
			close(ch)
		}
	}
